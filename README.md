...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/commitizen-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14853&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/commitizen-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `commitizen` can be installed with:

```
conda install commitizen
```

It is possible to list all of the versions of `commitizen` available on your platform with:
